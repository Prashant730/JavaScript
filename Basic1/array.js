...
//splice --> splice(starIndex , no of elements to delete , elements to add)
let arr11 = [1, 2, 3, 4, 5]
console.log(arr11.splice(2, 2, 90, 89, 88))
console.log(arr11)
console.log(arr11.splice())
console.log(arr11) //no change
console.log(arr11.splice(1, 1, 3))
console.log(arr11) //2-->3
console.log(arr11.splice(1, 1))
console.log(arr11) //3 will be deleted
